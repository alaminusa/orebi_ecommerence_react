  ...
  return (
    ...
    <Container>
        ...
        <div >
         ...
         <Paragraph text='Yes' className='text-secondaryColor text-sm font-dm font-normal pr-6'/>
         <Input inType="checkbox" className="mr-3"/>
         <Paragraph text='No' className='text-secondaryColor text-sm font-dm font-normal '/>
         </Flex>
